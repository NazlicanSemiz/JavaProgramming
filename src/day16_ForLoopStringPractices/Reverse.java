...
public class Reverse {
    public static void main(String[] args) {
        ...
        result += str.charAt(2); // d
        result += str.charAt(1); // o
        result += str.charAt(0); // W
*/

        for (int i= str.length()-1 ; i>=0 ; i--){ // i:index numbers of str(starting last index to 0)
         result += str.charAt(i); // adding the reserved version of str
        }
