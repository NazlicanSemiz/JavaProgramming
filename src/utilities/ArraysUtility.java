...
public class ArraysUtility {
     ...
     // prints each integer of an integer array in separte lines
    ...
    // // prints each integer of an double array in separte lines
    ...
    // prints each integer of an char array in separte lines
    ...
    // prints each integer of an String array in separte lines
    ...
    // returns the minimum number forom integer array
    public static int min(int[] numbers){
        Arrays.sort(numbers);
        return numbers[0];
    }

    // returns the minimum number forom doble array
...
//                                       [1,1,1,2,3,4,5]   1
    ...
    // replace the elements of array at given index with he new element
    ...
    // removes the dulicates from the given array, returns the new array
